import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, N as shimExports, v as Primitive, K as useCallbackRef$1, G as useLayoutEffect2, a as cn, o as useComposedRefs, y as Primitive$1, p as composeEventHandlers, O as dispatchDiscreteCustomEvent, H as reactDomExports, s as createContextScope$1, R as ReactDOM, z as useDirection, Q as Presence, T as createRovingFocusGroupScope, J as createCollection, U as Item, V as Root$3, M as createSlot, W as composeRefs, D as useControllableState, F as useId, X as createContext2, g as Link, Y as useInternetIdentity, d as useQueryClient, Z as useRouter, B as Button, n as Activity, $ as useActor, a0 as createActor } from "./index-BwdZZcZ7.js";
/**
...
const CalendarClock = createLucideIcon("calendar-clock", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Menu$1 = createLucideIcon("menu", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function AdminNav({ mobile = false, onNavigate }) {
  if (mobile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        ...
        children: NAV_ITEMS$1.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to,
            onClick: onNavigate,
            ...
            activeProps: {
              className: "flex flex-col items-center gap-0.5 px-2 py-2 rounded-lg text-xs font-medium transition-colors min-w-0 text-primary bg-primary/10"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5 flex-shrink-0" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-1 p-3", "data-ocid": "admin-sidebar-nav", children: NAV_ITEMS$1.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      to,
      onClick: onNavigate,
      ...
      activeProps: {
        className: "flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors bg-primary text-primary-foreground shadow-sm"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5 flex-shrink-0" }),
...
function PatientNav({ mobile = false, onNavigate }) {
  if (mobile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        ...
        children: NAV_ITEMS.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            to,
            onClick: onNavigate,
            ...
            activeProps: {
              className: "flex flex-col items-center gap-0.5 px-3 py-2 rounded-lg text-xs font-medium transition-colors min-w-0 text-primary bg-primary/10"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-5 h-5 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: label })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col gap-1 p-3", "data-ocid": "patient-sidebar-nav", children: NAV_ITEMS.map(({ to, label, icon: Icon }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      to,
      onClick: onNavigate,
...
function Logo() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 min-w-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-8 h-8 bg-primary rounded-lg flex items-center justify-center shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "w-4 h-4 text-primary-foreground" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground font-display leading-tight truncate", children: "City Health" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground leading-tight truncate", children: "Diagnostics" })
    ] })
  ] });
}
function UserMenu({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-7 h-7", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary/10 text-primary text-xs font-semibold", children: initials }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:block text-sm font-medium text-foreground max-w-[100px] truncate", children: userName ?? "User" })
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-48", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground truncate", children: userName ?? "User" }) }),
...
function Layout({ children, userRole, userName }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-sm sticky top-0 z-40 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-14 px-4 max-w-screen-2xl mx-auto w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        isMobile && /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: sidebarOpen, onOpenChange: setSidebarOpen, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "left", className: "w-64 p-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2.5 p-4 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(NavComponent, { onNavigate: () => setSidebarOpen(false) })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1 right-1 w-2 h-2 bg-destructive rounded-full" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(UserMenu, { userName, onLogout: handleLogout })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 overflow-hidden max-w-screen-2xl mx-auto w-full", children: [
      !isMobile && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "aside",
        {
          ...
          "data-ocid": "sidebar",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavComponent, {}) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground text-center", children: [
              "© ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "main",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 md:p-6 lg:p-8", children })
        }
      )
    ] }),
    isMobile && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0 bg-card border-t border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(NavComponent, { mobile: true }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground text-center pb-2 pt-1", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        ".",
        " ",
